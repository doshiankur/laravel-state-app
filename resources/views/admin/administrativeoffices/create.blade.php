...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="{{ asset('/webpanel/administrativeoffices') }}"> Administrativeoffices</a></li>
        <li class="active">Create New</li>
    </ol>

    {!! Form::open(['url' => '/webpanel/administrativeoffices',
                    'class' => 'form-horizontal',
                    'id'=>'administrativeoffices']) !!}

    @include ('admin.administrativeoffices.form')
...
<script type="text/javascript">
    $(document).ready(function(){
        $('#administrativeoffices').validate({
                debug: false,
                errorClass: "help-block",                
                ignore: 'input:hidden:not(input:hidden.required)',
                errorElement: "p",
                rules: {
                    'strAdministrative': 'required',
                    'strLanguageCode': 'required',
                    'strPageName':'required'
                },
                messages: {
                    'strAdministrative': 'Title is required',
