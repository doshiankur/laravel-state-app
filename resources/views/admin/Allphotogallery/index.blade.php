        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    {!! Form::open(['url' => '/webpanel/allPhotoGallery/'.$photogalleryid, 'class' => 'form-horizontal', 'id' => 'eventgalleryform', 'files' => true]) !!}
             ...
             <div class="box">
                @if(!empty($photogallery))
                    ...
                    <div id="Gallery_{{$gallery->id}}" style="width: 23%; padding: 10px; float:left; margin:10px;position: relative">
                       <img src="{{ asset('/public/upload/AllImageGallery/thumbnail/'.$gallery->StrEventImg) }}" height="200px" width="200px">
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#eventgalleryform').validate({
            ...
            errorElement: "p",
            rules: {
                'StrEventImg[]': 'required',
            },
            messages: {
                'StrEventImg[]': 'Event Gallery Image is required',
            },
    ...
    function deleteimagegallery(id, eventid) {
        ...
        $.ajax({
            url: '{{ asset("/webpanel/allPhotoGallery/deleteeventgallery") }}',
            type: "POST",
            headers: {
