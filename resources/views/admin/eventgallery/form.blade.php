        ...
        <div class="form-horizontal">
            <div class="box-body">
               <!-- <div class="form-group">
                ...
                <div class="form-group">
                    {!! Form::label('StrEventImg', 'Event Image Tags: ', ['class' => 'col-sm-2 control-label']) !!}
                    <div class="col-sm-8">
                ...
                <div class="box-footer">
                    <div class="form-group">
                        <div class="col-md-offset-4 col-md-4">
                            ...
                            <a href="{{ url('/webpanel/eventgallery/'.$eventgalleryid) }}" title="Cancel" class="btn btn-warning"><i class="fa fa-arrow-left" aria-hidden="true"></i> Cancel</a>
                        </div>
                    </div>
                </div>
                <!-- box-footer -->
