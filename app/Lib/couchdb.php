...
public function __construct($username = null, $password = null, $db = 'state' , $host = null, $port = null, $ip = null) {
	...
	*/
	...
	if(!$file){
	curl_setopt($ch, CURLOPT_HTTPHEADER,array('Content-type:application/json',"Authorization: Basic YWRtaW46RGVtbzEyMw=="));
	}
		else{
	 curl_setopt($ch, CURLOPT_HTTPHEADER,array('Content-type: '.$content_type,"Authorization: Basic YWRtaW46RGVtbzEyMw=="));
		}
